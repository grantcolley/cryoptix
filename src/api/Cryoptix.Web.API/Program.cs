...
try
{
    ...
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_KLINE_CAPACITY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_TRADE_CAPACITY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_TRADE_FULL_MODE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_KLINE_FULL_MODE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_KLINE_BROADCAST_CAPACITY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_TRADE_BROADCAST_CAPACITY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_INDICATORS_BROADCAST_CAPACITY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_SIGNAL_BROADCAST_CAPACITY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_KLINE_BROADCAST_FULL_MODE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_TRADE_BROADCAST_FULL_MODE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_INDICATORS_BROADCAST_FULL_MODE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.STRATEGY_CHANNEL_OPTIONS_SIGNAL_BROADCAST_FULL_MODE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.AUTH_DOMAIN]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.AUTH_AUDIENCE]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.AUTH_ISSUER]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.CORS_POLICY]}");
    Console.WriteLine($"{builder.Configuration[ConfigKeys.CORS_ORIGINS_URLS]}");

    Console.WriteLine("STARTUP: configuration load");
    ...
    Console.WriteLine("STARTUP: configuration loaded");
    ...
    Console.WriteLine("STARTUP: configuration validation completed");

    builder.Services.Configure<AuthOptions>(builder.Configuration.GetRequiredSection("Auth"));

    Console.WriteLine("STARTUP: authentication services configured");
    ...
    Console.WriteLine("STARTUP: CORS services configured");

    builder.Services.AddApiExceptionHandling();

    builder.Services.AddSingleton<IAuthorizationHandler, AllowedClientHandler>();

    Console.WriteLine("STARTUP: authorization services configured");
    ...
    Console.WriteLine("STARTUP: BinanceApi credentials configured");
    ...
    Console.WriteLine("STARTUP: strategy channel services configured");
    ...
    Console.WriteLine("STARTUP: services configured");

    WebApplication app = builder.Build();

    Console.WriteLine("STARTUP: application built");
