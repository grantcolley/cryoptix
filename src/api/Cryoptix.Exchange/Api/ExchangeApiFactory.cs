namespace Cryoptix.Exchange.Api
{
    ...
    {
        private readonly Dictionary<Market.Models.Exchange, IExchangeRestApi> _restApis = restApis.ToDictionary(x => x.Exchange);
        private readonly Dictionary<Market.Models.Exchange, IExchangeSubscriptionApi> _subscriptionApis = subscriptionApis.ToDictionary(x => x.Exchange);

        public ExchangeApi GetApi(Market.Models.Exchange exchange)
        {
        ...
        public IExchangeRestApi GetRestApi(Market.Models.Exchange exchange)
        {
        ...
        public IExchangeSubscriptionApi GetSubscriptionApi(Market.Models.Exchange exchange)
        {
